...
Клиент вызвал `POST /receipts/read`, Message Service публикует это событие для
...
| `message.created` | Message Service | Realtime Gateway, Search | `chat_id` | 16 | 7 дней |
